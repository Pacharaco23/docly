         ...
         <x-wire-card class="mb-8">
            <div class="lg:flex lg:justify-between lg:items-center">
                ...
                <div class="flex space-x-3 mt-6 lg:mt-0">
                    <x-wire-button outline href="{{ route('admin.doctors.schedules', $doctor) }}">
        ...
        <x-wire-card>
            <div class="space-y-4">
                ...
                <x-wire-native-select 
                    ...
                    name="active"    
                >
                    <option value="1" @selected(old('status',$doctor->active) == 1)>
                        Activo
                    </option>
                    <option value="0" @selected(old('status',$doctor->active) == 0)>
                        Inactivo
                    </option>
                </x-wire-native-select>
