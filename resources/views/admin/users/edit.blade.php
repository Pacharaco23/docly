            ...
            <div class="space-y-4">
                <div class="grid lg:grid-cols-2 gap-4">
                    <x-wire-input name="name" label='Nombre' required :value="old('name',$user->name)"
                        placeholder="Ingrese el nombre del usario" />
                    <x-wire-input name="email" label="Correo Electrónico" type="email" required :value="old('email',$user->email)"
                    ...
                    <x-wire-input name="dni" label="DNI" required :value="old('dni',$user->dni)"
