<div>
    <x-wire-card class="mb-8">
        <div class="lg:flex lg:justify-between lg:items-center">
            ...
            <div class="lg:flex lg:space-x-3 space-y-2 lg:space-y-0 mt-4 lg:mt-0">
                ...
                <x-wire-button class="w-full lg:w-auto" outline gray sm
                    x-on:click="$openModal('previousConsultationsModal')">
    ...
    <x-wire-card>
        ...
        <div class="flex justify-end mt-6">
            <x-wire-button wire:click="save" spinner="save" :disabled="!$appointment->status->isEditable()">
